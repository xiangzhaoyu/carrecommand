...
import com.pdstudio.carrecom.ui.view.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener{
	...
	public boolean haveMore=false;//外部控制，是否还有更多可以加载
    ...
    private void initHeaderViewAndFooterViewAndListView(Context context){
         ...
         * 自定义脚部文件
         */
        mFooterView = LayoutInflater.from(context).inflate(R.layout.view_pulldown_footer, null);
    ...
    private void showFooterView(){
        if(mListView.getFooterViewsCount() == 0 && isFillScreenItem()){
        	...
        	footerParent.addView(mFooterView,LayoutParams.FILL_PARENT,LayoutParams.FILL_PARENT);
