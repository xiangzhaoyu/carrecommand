...
import com.pdstudio.carrecom.ui.view.MyProgressDialog;
...
public class HttpExecuteJson{
	...
	public void get(String url, Map<String, Object> params) {
		try{
		if (com.pdstudio.carrecom.tools.NetUtil.getNetworkState(_context) != com.pdstudio.carrecom.tools.NetUtil.NETWORN_NONE) {
		String newUrl = url;
		if (params != null) {
